...
public class LinkedPositionalList<E> implements PositionalList<E> {
    ...
    private static class Node<E> implements Position<E> {
        ...
        public E getElement() throws IllegalStateException {
            if (next == null)                         // convention for defunct node
                throw new IllegalStateException("Exercise1.Position no longer valid");
            return element;
        }
    ...
    // instance variables of the Exercise1.LinkedPositionalList
    ...
    // private utilities
    /**
     * Verifies that a Exercise1.Position belongs to the appropriate class, and is
     * not one that has been previously removed. Note that our current
     * implementation does not actually verify that the position belongs
     * to this particular list instance.
     *
     * @param p   a Exercise1.Position (that should belong to this list)
    ...
    /**
     * Returns the given node as a Exercise1.Position, unless it is a sentinel, in which case
    ...
    private class PositionIterator implements Iterator<Position<E>> {
        ...
        /** A Exercise1.Position of the containing list, initialized to the first position. */
        private Position<E> cursor = first();   // position of the next element to report
        /** A Exercise1.Position of the most recent element reported (if any). */
