...
// Exercise 2 - This method can be found and implemented inside the LinkedStack.java class
...
//    }
    ...
    private void showStack() {
        try {
            ...
            System.out.println("\nStack S size: " + sizeS + "; Top: " + numS);
        }
        catch(Exception e) {
            System.out.println("Stack S is empty. " + e);
        }

        try {
            int sizeT = linkedStackT.size();
            double numT = linkedStackT.top();
            System.out.println("Stack T size: " + sizeT + "; Top: " + numT + "\n");
        }
        catch(Exception e) {
            System.out.println("Stack T is empty. " + e);
        }
    }
