...
// Exercise 3 - This method can be found and implemented inside SinglyLinkedList.java class

//    public void concatenate(SinglyLinkedList<E> list2) {
//
//        // last node of the 1st list
//        System.out.println(this.tail.getNext());
//        SinglyLinkedList.Node<E> lastNode = this.tail;
//
//        // two ends of the 2nd list - the first and last node
//        SinglyLinkedList.Node<E> list2FirstNode = list2.head;
//        SinglyLinkedList.Node<E> list2LastNode = list2.tail;
//
...
//    }
    ...
    public void append2to1() {
        ...
        try {
            ...
            System.out.println("Queue 1 is empty. Error: " + e);
        }
        ...
        try {
            ...
            System.out.println("Queue 2 is empty. Error: " + e);
        }
    }
}
