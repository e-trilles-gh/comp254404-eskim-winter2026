...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
    ...
    public Position<E> preorderNext(Position<E> p) {
        // if p is the parent and left child is not empty
        // then left child is the preorderNext(p)
        if (left(p) != null) {
            return left(p);

        // if p is the parent, left child is empty, and
        // right child is not empty,
        // then the right child is the preorderNext(p)
        } else if (right(p) != null) {
            return right(p);

        // if p does not have children, then move up one step,
        // each step moving up is checked if moving from left or right child.
        // moving up is stopped once coming from left child, and
        // right sibling is not empty
        } else {
            ...
            while (true) {
                if (p == right(parent) || right(parent) == null) {
                    ...
                    // then right sibling is the preorderNext(p)
                    return right(parent);
                }
            }
        }
